...
line-height:normal;mso-outline-level:1'><b><span lang=EN-US style='font-size:
24.0pt;font-family:"Times New Roman",serif;mso-fareast-font-family:"Times New Roman";
color:black;mso-font-kerning:18.0pt;mso-ansi-language:EN-US;mso-fareast-language:
NO-BOK'>Kitchen-lamp controlled by Alexa<o:p></o:p></span></b></p>

<p class=MsoNormal><span lang=EN-US style='font-size:14.0pt;line-height:107%;
mso-ansi-language:EN-US'>My wife demanded that our kitchen lamp should be
changed. She thought that the lamp now is old and not fancy any more. <span
class=GramE>So</span> we went to a lamp store to look for a new lamp for the
...
<p class=MsoNormal><span lang=EN-US style='font-size:14.0pt;line-height:107%;
mso-ansi-language:EN-US'>After some efforts we succeeded in mounting the lamp
in the ceiling. But when we turned it on, the light emitted was too high. <span
class=GramE>So</span> we concluded that the renewal project of the kitchen lamp
was not a great success.<o:p></o:p></span></p>

<p class=MsoNormal><span lang=EN-US style='font-size:14.0pt;line-height:107%;
mso-ansi-language:EN-US'>But then the Alexa system that we have implemented in
...
and Alexa. Why not make a similar device for the new lamp also? <o:p></o:p></span></p>
...
<p class=MsoNormal><span lang=EN-US style='font-size:14.0pt;line-height:107%;
mso-ansi-language:EN-US'>At eBay I found at LED pulse width controller able to
control a current up to 700mA with an input power voltage of 35 volt. In order
to get the 35 volts from the <span class=GramE>45 volt</span> DC power unit I
found a regulator that could to the task. The PWD-pulses could be delivered
from <span class=GramE>a</span> ESP8266 D1 mini device with a WiFi connection.
That device demand 5 volts input, so I had to use another regulator to get
that. <o:p></o:p></span></p>

<p class=MsoNormal><span lang=EN-US style='font-size:14.0pt;line-height:107%;
mso-ansi-language:EN-US'>The software in the microcontroller was accomplished
from example Arduino sketches form the <span class=SpellE>SPI.h</span>, <span
class=SpellE>WiFi.h</span>, <span class=SpellE>PubSubClient.h</span>, <span
class=SpellE>Adafruit_GFX.h</span>, Adafruit_SSD1306.h, <span class=SpellE>EEPROM.h</span>,
<span class=SpellE>ESPmDNS.h</span>, <span class=SpellE>WiFiUdp.h</span>, and <span
class=SpellE>ArduinoOTA.h</span>.<o:p></o:p></span></p>
