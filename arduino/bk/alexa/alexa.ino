...
#define WIFI_SSID "dlink"//Set your Wifi name
#define WIFI_PASS "12345abc"//Set your Wifi Password
#define SERIAL_BAUDRATE                 115200

fauxmoESP fauxmo;
//declare switching pins
#define RGBCTL 1 //Change pins according to your NodeMCU/ESP pinouts
